...
dotnet nuget push  --no-build --no-restore -v m build/$name/$ver/*.nupkg -k oy2gwo5jfyxcggpruhtairs6jiw6v5autb2e7vmzqecgpe -s https://api.nuget.org/v3/index.json || error_exit "Dotnet nuget push failed."
